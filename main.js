	...
	mainWindow.webContents.on('did-finish-load', function () {
		mainWindow.webContents.insertCSS(
			'::-webkit-scrollbar{ width: 10px;}' +
				...
				'div.notion-frame > div.notion-scroller{margin:40px 0 0 0;}' + // 스크롤
				'div.notion-frame > div.notion-scroller > div:nth-child(1) > div{left: 0px !important;padding:20px !important;height:40px !important;-webkit-app-region: drag;position: fixed;top: 0px;background-color: gray;z-index: 100;}' + // 제목 셀
				'div.notion-frame > div.notion-scroller.vertical.horizontal > div:nth-child(1) > div > div.notion-selectable.notion-page-block > div{font-size:14px}' + // 제목 셀
